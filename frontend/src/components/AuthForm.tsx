    ...
    <div className="border w-1/2 rounded-lg shadow">
      <Formik
        ...
        onSubmit={async (values, { setSubmitting }) => {
          ...
          const resp: UserWithToken = await fetch(
            `http://localhost:8080/users/${isSignIn ? 'sign-in' : 'sign-up'}`,
            {
              method: 'POST',
            ...
            <Form className="flex flex-col w-1/2 mx-auto">
              ...
              {!isSignIn && (
                <>
                  ...
                  <div className="flex flex-col">
                    <label htmlFor="emailConfirm" className="font-semibold">
                      Confirm Email
                    </label>
                    <Field
                      type="email"
              ...
              <button
                type="submit"
                className="bg-emerald-600 text-white font-bold py-2 px-4 rounded my-4"
